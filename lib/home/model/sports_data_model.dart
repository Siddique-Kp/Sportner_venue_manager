...
SportsDataModel sportsDataModelFromJson(String str) => SportsDataModel.fromJson(json.decode(str));

String sportsDataModelToJson(SportsDataModel data) => json.encode(data.toJson());
...
class Response {
    ...
    factory Response.fromJson(Map<String, dynamic> json) => Response(
        id: json["_id"],
        sport: json["sport"],
        facilityDetails: json["facilityDetails"] == null ? [] : List<FacilityDetail>.from(json["facilityDetails"]!.map((x) => FacilityDetail.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "_id": id,
        "sport": sport,
        "facilityDetails": facilityDetails == null ? [] : List<dynamic>.from(facilityDetails!.map((x) => x.toJson())),
    };
}
